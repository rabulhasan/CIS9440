...
WITH all_locations AS (
   ...
   SELECT DISTINCT
      borough,
      incident_zip AS zip_code -- captured form the staged table (HINT: look @ dimensional model & staging data!)
   ...
   SELECT DISTINCT
       borough,
       zip AS zip_code -- captured form the staged table (HINT: look @ dimensional model & staging data!)
